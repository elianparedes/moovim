...
class routineCycleApi{
    ...
    static async add(routineCycle, controller){
        return await Api.post(routineCycleApi.getUrl(routineCycle.id), true, routineCycle, controller);
    }
    ...
    static async modify(routineId, fullRoutineCycle, controller){
        return await Api.put(routineCycleApi.getUrl(routineId, fullRoutineCycle.id), true, fullRoutineCycle, controller);
    }
...
class RoutineCycle{
    ...
    constructor(name, detail, type, repetitions, metadata){
        this.name=name;
        this.detail=detail;
        this.type=type;
